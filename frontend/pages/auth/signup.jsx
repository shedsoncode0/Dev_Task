...
function Signup() {
  ...
  const handleSubmit = async (e) => {
    ...
    const apiEndPoint = `${PORT}/api/auth/register`;
    alert(apiEndPoint);
    ...
    <div className="">
      <div className="flex justify-center items-center flex-col text-center gap-2 mt-7">
        ...
        <p className="text-[#4E5D78] text-[14px] font-medium">
          Create an account to continue and connect with the world
        </p>
        <div className="flex bg-white drop-shadow-xl p-9 justify-center items-center rounded-lg gap-2 mt-2 flex-col">
          ...
          >
            ...
            <button
              type="submit"
              className="w-full h-11 rounded-lg bg-cyan-500 text-white font-medium"
            >
              Sign Up
            </button>
            {/* </Link> */}
          ...
          <h1 className="mt-2 text-[14px] font-semibold text-[#4E5D78]">
            ...
            <Link href="login">
              <span className="text-cyan-500 ml-2">Sign In</span>
            </Link>{" "}
          </h1>
        </div>
      </div>
